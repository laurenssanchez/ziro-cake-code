...
$(".selectAll1").change(function(event) {
	...
	var costmin =  document.getElementById("costmin").value; //costmax
	var id ;
	...
	retefuente  = (pago * 0.11) + (debtsTotal * 0.11);
	// iva  = 0;

	var totalcomision = pago + iva + debtsTotal;
	var totalpago = quote - totalcomision + retefuente;
	...
	document.getElementById("disbursments1_retefuente").innerHTML = "Pago: <span class='pago1Retefuente pago1'>"+ formatterPeso.format(retefuente) +"</span>";
	...
	document.getElementById("disbursments1_pagotx").value = quote;
...
$(".selectAll2").change(function(event) {
	...
	document.getElementById("disbursments2_pagotx").value = quote;
});
