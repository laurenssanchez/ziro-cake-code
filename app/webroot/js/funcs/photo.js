...
$("body").on("click", "#tomaFoto", function (event) {
	...
	if (idCanvas === "canvasFotoUp") {
		document.getElementById("imgUpFile").src = "";
	} else if (idCanvas === "canvasFotoDown") {
		document.getElementById("imgDownFile").src = "";
	} else if (idCanvas === "canvasFotoUser") {
		document.getElementById("imgFotoUser").src = "";
	}
});
...
function dataBase64URLtoFile(dataurl, filename) {
	...
	filename = dateEnd + Math.floor(Math.random() * 988888888888) + filename;
