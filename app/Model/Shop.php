...
class Shop extends AppModel {
	...
	public $actsAs = array(
	   'Upload.Upload' => array(
	         'chamber_commerce_file' => array(
	           ...
	           'path'         => '{ROOT}{DS}webroot{DS}files{DS}shops{DS}',
	           'deleteOnUpdate' => true,
	...
	public $hasMany = array(
		'ShopReference' => array('className' => 'ShopReference','foreignKey' => 'shop_id','dependent' => false,),
		'ShopPayment' => array('className' => 'ShopPayment','foreignKey' => 'shop_id','dependent' => false,),
		'ShopCommerce' => array('className' => 'ShopCommerce','foreignKey' => 'shop_id','dependent' => false,),
		// 'User' => array('className' => 'User','foreignKey' => 'shop_id','dependent' => false,)
	);
	...
	public function buildConditions($params=array()) {
		...
		if(!empty($params['q'])) {
			...
			$conditions['OR'] = array(
				'LOWER(Shop.social_reason) LIKE'=>"%{$params['q']}%",
				'LOWER(Shop.nit) LIKE'=>"%{$params['q']}%",
			);
		}
		return $conditions;
	}
