     ...
     <div class="row">
          ...
          <div class="row">
              ...
              <div class="col-md-7 pt-3">
                  <div class="form-group">
                    <?php echo $this->Form->input('code', array('class' => 'form-control','disabled' => 'disabled','label'=>'Código del proveedor','value'=>'17090813','div'=>false,'placeholder'=>'Código de la tienda donde solicitas el crédito','required' => true)); ?>
                  </div>
              </div>
          </div>
        </div>
          ...
          <div class="row">
              ...
              <div class="col-md-7 pt-3">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <input id="moneyRange" type="range" min="50000" max="750000" step="10000" value="50000" class="range-borrow ">
        ...
        <div class="col-md-12 bg-white text-center pt-3 pb-5">
          <div class="pb-3">
              ...
              <input type="submit" class="btn btn-success btn-lg mt-2" value="Guardar">
          </div>
        </div>
