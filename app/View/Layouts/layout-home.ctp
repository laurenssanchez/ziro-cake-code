...
<html lang="en">
  <head>
    ...
    <?php echo $this->Html->css(['/vendors/bootstrap/dist/css/bootstrap.min.css','/vendors/font-awesome/css/font-awesome.min.css','/css/home.css?v=1.1.0','/css/responsive.css?v=1.1.0']); ?>
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-246507148-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-246507148-1');
</script>
  </head>
  <body>
    <div id="preloader">
