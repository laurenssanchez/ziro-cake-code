<div class="invoice recibopago">
	<header>
		<div class="row">
			<div class="col"><img class="w-25" src="<?php echo $this->Html->url("/img/credishop.svg") ?>" /></div>
	...
	<main>
		<div class="row contacts">
			...
			<div class="col invoice-details">
				<h1 class="invoice-id">Recibo # <?php echo str_pad($creditRequest["Credit"]["id"], 6, "0", STR_PAD_LEFT);  ?></h1>
		...
		<table class="table ">
			...
			<tbody>
				<tr>
					...
					<td class="">$ <?php echo number_format($creditRequest["Credit"]["value_request"]) ?></td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
					...
					<td>$<?php echo number_format($creditRequest["Credit"]["value_request"]) ?></td>
				</tr>
<!-- 				<tr>
					<td colspan="2"></td>
