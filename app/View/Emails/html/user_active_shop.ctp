...
>
  <head>
    ...
    <title>Activación de proveedor</title>
    <!--[if mso]>
      <noscript>
        <xml>
                  ...
                  <tr>
                    ...
                    <td style="color: #153643; height: 70px">
                      <p
                        ...
                        "
                      >
												Queremos informarte que tu cuenta creada en SOMOS ZÍRO ha sido activada correctamente, ya puedes ingresar a registrar tus sucursales y tus empleados.
                      </p>
                      <p
                        style="
                          margin: 0;
