            ...
            <tr>
              <td style="color: #153643; height: 70px; padding: 0">
                <p
                  ...
                  "
                >
                  🎉 Felicidades, <?php echo $customerName ?> ya eres totalmente
                  ...
                  <tr>
                    ...
                    <td style="color: #153643; height: 70px">
                      <p
                        ...
                        "
                      >
                        Yuhuuu! Ya haces parte de esta gran familia. ¿Habías
                        pensado alguna vez en comprar algo hoy y pagarlo después
                        sin que te cueste más? Zí, esto es real, bienvenid@s a
                        Zíro. <br /><br />
                        Recuerda seguirnos en nuestras redes sociales, <br />
                        siempre tenemos cosas nuevas.  <br />
                      </p>
                      <p
                        style="
                          margin: 0;
                          ...
                          text-align: center;
                        ">
                            Por favor verifica tu identidad en el siguiente enlace: <a href="https://onx.la/f0d92">Verificar identidad</a>
                        </p>
