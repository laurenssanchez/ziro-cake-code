		...
		<div class="x_panel">
			<div class="x_content">
				...
				<?php echo $this->Form->create('Shop', array('role' => 'form','data-parsley-validate=""','class'=>'form-horizontal form-label-left',"type"=>"file")); ?>
						...
						<div class='item form-group'>
								<?php echo $this->Form->label('Shop.chamber_commerce_file',__('Adjunte Cámara de comercio'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
						...
						<div class='item form-group'>
								<?php echo $this->Form->label('ShopReference.1.commerce',__('Comercio que posee'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
						...
						<div class='item form-group'>
								<?php echo $this->Form->label('ShopReference.2.commerce',__('Comercio que posee'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
