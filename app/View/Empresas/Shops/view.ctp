					...
					<table class="table table-hover">
						<tbody>
							<tr>
								...
								<td><?php echo Configure::read("PLANES.".$shop['Shop']['plan']); ?> - Comisión PAGO 1: <b><?php echo number_format($shop['Shop']['cost_min']); ?></b> - Comisión PAGO 2: <b><?php echo number_format($shop['Shop']['cost_max']); ?></b></td>
							</tr>
