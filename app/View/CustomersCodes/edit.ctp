...
<div class="page-title">
	<div class="title_left">
		<h3><?php echo __('Editar').' '.__('Customers Code'); ?></h3>
	</div>
	...
	<div class="title_right">
		<div class="col-md-8 col-sm-8  form-group pull-right top_search">
		    ...
		    <a class="btn btn-sm btn-fill btn-info" href="<?php echo $this->Html->url(array('action'=>'view',$this->Utilidades->encrypt($this->request->data['CustomersCode']['id'])));?>">
		        <i class="fa fa-eye"></i>
		        <?php echo __('Ver'); ?>
		    </a>
