			...
			<div class="x_content">
				...
				<?php echo $this->Form->create('Shop', array('role' => 'form','data-parsley-validate=""','class'=>'form-horizontal form-label-left',"type"=>"file")); ?>
						...
						<div class='item form-group'>
								...
								<div class='col-md-6 col-sm-6'>
								<?php echo $this->Form->input('guild', array('class' => 'form-control border-input','label'=>false,'div'=>false,"options" => Configure::read("GREMIOS"), "empty" => "Seleccionar")); ?>
								</div>
						</div>
						<div class='item form-group'>
						...
						<div class='item form-group'>
								<?php echo $this->Form->label('Shop.chamber_commerce_file',__('Adjunte Cámara de proveedor <br> <small style="color:red;">Importante! </small><small>El archivo debe subirse en formato pdf.</small>'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
						...
						<div class='item form-group'>
								<?php echo $this->Form->label('Shop.rut_file',__('Adjunte RUT <br> <small style="color:red;">Importante! </small><small>El archivo debe subirse en formato pdf.</small>'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
						...
						<div class='item form-group'>
								<?php echo $this->Form->label('Shop.identification_admin',__('Número de identificación'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
						...
						<div class='item form-group'>
								<?php echo $this->Form->label('Shop.name_admin',__('Nombre'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
						...
						<div class='item form-group'>
								<?php echo $this->Form->label('Shop.cellpone_admin',__('Teléfono'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
						...
						<!-- <div class='item form-group'>
								<?php echo $this->Form->label('Shop.image_admin',__('Foto del administrador <br> <small style="color:red;">Importante! </small><small>La imagen debe subirse en formato jpg.</small>'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
						...
						<div class='item form-group'>
								<?php echo $this->Form->label('Shop.identification_up_file',__('Foto cédula parte delantera <br> <small style="color:red;">Importante! </small><small>La imagen debe subirse en formato jpg.</small>'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
						...
						<div class='item form-group'>
								<?php echo $this->Form->label('Shop.identification_down_file',__('Foto cédula parte trasera <br> <small style="color:red;">Importante! </small><small>La imagen debe subirse en formato jpg.</small>'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
						...
						<div class='item form-group'>
								<?php echo $this->Form->label('Shop.account_file',__('Certificado Bancario'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
						...
						<div class='item form-group d-none'>
								...
								<div class='col-md-6 col-sm-6'>
								<?php echo $this->Form->input('cost_min', array('class' => 'form-control border-input','label'=>false,'div'=>false, "pattern"=> "^[0-9]+([,][0-9]+)?$", "value"=>Configure::read("PLAN_COST_VALUES.1.min"))); ?>
								</div>
						</div>
						<div class='item form-group d-none'>
