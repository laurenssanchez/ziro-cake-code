...
<div class="page-title">
	<div class="row">
		...
		<div class="col-md-6 text-right">
			...
			<a href="<?php echo $this->Html->url(["action"=>"excel_shops"]) ?>" target="_blank" class="btn btn-info">
				Descargar proveedores <i class="fa fa-file"></i>
			</a>
			<a href="<?php echo $this->Html->url(["action"=>"excel_commerces"]) ?>" target="_blank" class="btn btn-warning">
				Descargar sucursales <i class="fa fa-file"></i>
			</a>
		</div>
		<div class="col-md-3">
				...
				<table cellpadding="0" cellspacing="0" class="table table-striped table-hover">
					<thead class="text-primary">
						<tr>
							...
							<th><?php echo $this->Paginator->sort('credits_line', __('Linea de Credito')); ?></th>
						...
						if(!empty($shops)): ?>
							<?php 					 foreach ($shops as $shop): ?>
								<tr>
									...
									<td><?php echo h($shop['CreditsLine']['name']); ?>&nbsp;</td>
									...
									<td class="td-actions">
										...
										<a href="<?php echo $this->Html->url(array('action' => $shop["Shop"]["state"] == "1" ? "delete_data" : "change_state",$this->Utilidades->encrypt($shop['Shop']['id']))); ?>" class="btn btn-outline-danger btn-xs changeState">
