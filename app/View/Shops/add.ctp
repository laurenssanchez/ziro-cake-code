	...
	<div class="row">
		...
		<div class="col-md-6 text-right">
			<a class="btn btn-secondary"  href="<?php echo $this->Html->url(array('action'=>'index'));?>">
            	...
            	<?php echo __('Ver proveedores registrados'); ?>
            </a>
		</div>
		...
		<div class="x_panel">
			<div class="x_content">
				...
				<?php echo $this->Form->create('Shop', array('role' => 'form','data-parsley-validate=""','class'=>'form-horizontal form-label-left',"type"=>"file")); ?>
						...
						<div class='item form-group'>
								<?php echo $this->Form->label('Shop.rut_file',__('Adjunte RUT <br> <small style="color:red;">Importante! </small><small>El archivo debe subirse en formato pdf.</small>
'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
						...
						<div class='item form-group'>
								...
								<div class='col-md-6 col-sm-6'>
								<?php echo $this->Form->input('cost_min.text', array('class' => 'form-control border-input','label'=>false, "value"=>Configure::read("PLAN_COST_VALUES.1.min"))); ?>
								</div>
						</div>
						<div class='item form-group'>
								<?php echo $this->Form->label('Shop.cost_max',__('Comisión pago 2'), array('class'=>'col-form-label col-md-3 col-sm-3 label-align'));?>
								<div class='col-md-6 col-sm-6'>
								<?php echo $this->Form->input('cost_max.text', array('class' => 'form-control border-input','label'=>false,"value"=>Configure::read("PLAN_COST_VALUES.1.max"))); ?>
